...
public class AddGeofences extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPrefs = (SharedPreferences) getBaseContext().getSharedPreferences(GeofenceUtils.SHARED_PREFERENCES,
    ...
    private void startAddActivity() throws ClassNotFoundException, IOException {
    	...
    	final String[] uiOptions = GeofenceUtils.generateNames(getApplicationContext());
    	final String[] classNames = GeofenceUtils.generateOptions(getApplicationContext());
    	ArrayAdapter<String> modeAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, android.R.id.text1, uiOptions);
    ...
    public class CommitTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String[] paramArrayOfString) {
            ...
            List<Address> s = null;
            try {
                s = geo.getFromLocationName(addressedit.getText()
                        .toString(), 1);
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            Editor editor = mPrefs.edit();
                ...
                GeofenceStore geofencestorage = new GeofenceStore(AddGeofences.this);
                 startidtemp = mPrefs.getInt(
                        "com.asdar.geofence.KEY_STARTID", -1);
                SimpleGeofence g = new SimpleGeofence(startidtemp.toString(), namedit.getText().toString(), buildAddress(s.get(0).getLatitude(), s.get(0).getLongitude()), 
                		s.get(0).getLatitude(), s.get(0).getLongitude(),
                        (float)Long.parseLong(radiusedit.getText().toString()),
                        Geofence.NEVER_EXPIRE,
                        Geofence.GEOFENCE_TRANSITION_DWELL | Geofence.GEOFENCE_TRANSITION_EXIT, 60000, 0);
        ...
        protected void onPostExecute(String str) {
            this.dialog.dismiss();
            AddGeofences.this.setResult(Integer.parseInt(str));
            AddGeofences.this.finish();
        }
